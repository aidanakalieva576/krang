...
import 'pages/admin/add_content.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      // ✅ только те маршруты, где НЕТ обязательных аргументов
      routes: {
      ...
      onGenerateRoute: (settings) {
        // ✅ edit movie по имени /edit_movie с обязательным movieId
        ...
        // твой старый /edit оставил, если где-то уже используется
