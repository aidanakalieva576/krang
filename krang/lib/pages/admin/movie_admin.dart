...
class _EditMoviePageState extends State<EditMoviePage> {
  ...
  final List<Review> reviews = [
    Review(
      ...
      rating: 4,
      date: 'August 29, 2023',
      text: 'A lot of stupidity wrapped in a pretty package...',
    ),
    Review(
      userName: 'Jane Doe',
      ...
      rating: 5,
      date: 'July 10, 2023',
      text: 'Absolutely loved the animation and storyline!',
    ),
    Review(
      userName: 'John Smith',
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  const Text("After:", style: TextStyle(color: Colors.white)),
                  const SizedBox(width: 12),
                  Expanded(
                    child: Container(
                      height: 40,
